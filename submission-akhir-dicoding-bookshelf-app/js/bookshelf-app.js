...
// Functions to generate the book, move, and delete the book
function generateId () {
    return +new Date();
}
...
searchBookForm.addEventListener('submit', function (searchEvent) {
    ...
    const searchBookInput = document.getElementById('search-book-input').value;
    for (const bookSingleTitle of bookTitleList) {
        if (bookSingleTitle.innerText.toLowerCase().includes(searchBookInput.toLowerCase())) {
